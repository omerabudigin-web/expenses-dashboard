...
const FA_TYPES = [
  ...
  { key:'machinery',  icon:'⚙️', label:'الآلات والمعدات الأخرى',    re:/مرصات|لحام|مشحمة|كمبريسور|ماطور|وحدة تبريد|مكينة قص|عربة/i },
  ...
  { key:'furniture',  icon:'🪑', label:'الأثاث والمفروشات',          re:/مكتب|كرسي|اثاث|دولاب|كنبه|خزنة|طاولة|موكيت|كنب/i },
