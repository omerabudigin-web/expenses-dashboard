...
function _aapBuildShell() {
  ...
  <details class="aap-explain" id="aap-explain">
    ...
    <div class="aap-explain-body" id="aap-explain-body">
      ...
      <p><strong>الإجمالي هنا أصغر من رصيد ح.77+78 الكامل</strong> لأن الأخير يضمّ تمويلات مصرفية وأطرافاً مرتبطة ودفعات مقدمة — انظر تاب تركيبة الالتزامات للصورة الكاملة.</p>
